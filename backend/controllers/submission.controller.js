...
export const get = async (req, res) => {
  try {
    ok(res, await submissionService.getById(req.params.id))
  } catch (e) {
    fail(res, e)
  }
}
...
export const mine = async (req, res) => {
  try {
    ok(res, await submissionService.mine(req.user._id))
  } catch (e) {
    fail(res, e)
  }
}
...
export const create = async (req, res) => {
  try {
    ok(res, await submissionService.create(req.body, req.user._id), 201)
  } catch (e) {
    fail(res, e)
  }
}
...
export const update = async (req, res) => {
  try {
    ok(res, await submissionService.update(req.params.id, req.body))
  } catch (e) {
    fail(res, e)
  }
}
...
export const assign = async (req, res) => {
  try {
    ok(
      res,
      await submissionService.assignEvaluator(
        req.params.id,
