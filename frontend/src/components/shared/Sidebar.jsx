      ...
      <div className="p-4 mt-auto">
        <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4 shadow-inner shadow-black/20">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white/5 border border-white/5 
                       rounded-xl text-text-3 text-[11px] font-bold uppercase tracking-widest py-2.5
                       hover:bg-red/10 hover:text-red hover:border-red/20 transition-all active:scale-95"
          >
            <span>⎋</span>
            Sign Out
          </button>
