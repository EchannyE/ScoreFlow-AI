              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3 rounded-[12px] border border-white/5 bg-bg-3/50 px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-text-3 font-bold uppercase tracking-wider">Used in campaign cards and progress accents</div>
                  </div>
                </div>
              </div>
      ...
      {!campaigns.length && !isComposerOpen && (
        <Card className="border-dashed border-white/10 bg-bg-2/30">
          <div className="flex flex-col items-start gap-4">
            <div>
              <div className="text-[10px] text-green font-bold uppercase tracking-[0.2em] mb-2">No Campaigns Yet</div>
              <h3 className="font-display font-bold text-2xl text-white">Create the first campaign</h3>
            ...
            <Card key={c._id} hover accent={themeColor} className="group overflow-hidden">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  <div className="font-display font-black text-4xl tracking-tighter leading-none"
                       style={{ color: themeColor, filter: `drop-shadow(0 0 10px ${themeColor}33)` }}>
                    {c.completionPct ?? 0}<span className="text-sm ml-0.5 opacity-60">%</span>
                  </div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-white/5">
                  <div className="flex gap-6">
                    <div className="flex flex-col">
                      <span className="text-[10px] text-text-3 font-bold uppercase tracking-wider">Entries</span>
                      <span className="text-sm font-mono font-bold text-white">
                        {String(c.submissionsCount ?? 0).padStart(2, '0')}
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[10px] text-text-3 font-bold uppercase tracking-wider">Judges</span>
                      <span className="text-sm font-mono font-bold text-white">
                  ...
                  <div className="text-right">
                    <span className="text-[10px] text-text-3 font-bold uppercase tracking-wider block">Deadline</span>
              ...
              <div className="mt-6 flex justify-end">
                <Button variant="ghost" size="sm" className="text-[10px] font-bold uppercase tracking-[0.15em] hover:text-white">
                  Manage Campaign →
                </Button>
              </div>
            </Card>
