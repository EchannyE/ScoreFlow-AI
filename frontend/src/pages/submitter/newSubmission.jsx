...
export default function NewSubmission() {
  ...
  const validate = () => {
    ...
    if (
      ...
      e.access =
        'Provide at least one project access option: project URL, GitHub URL, demo URL, or file URL.'
    }
        ...
        <Card>
          <div className="flex flex-col gap-4">
            ...
            <div className="pt-2 border-t border-white/10">
              ...
              {errors.access && (
                <div className="mt-2">
                  <ErrorMsg>{errors.access}</ErrorMsg>
                </div>
              )}
              {errors.projectUrl && (
                <div className="mt-2">
                  <ErrorMsg>{errors.projectUrl}</ErrorMsg>
                </div>
              )}
              {errors.githubUrl && (
                <div className="mt-2">
                  <ErrorMsg>{errors.githubUrl}</ErrorMsg>
                </div>
              )}
              {errors.demoUrl && (
                <div className="mt-2">
                  <ErrorMsg>{errors.demoUrl}</ErrorMsg>
                </div>
              )}
              {errors.fileUrl && (
                <div className="mt-2">
                  <ErrorMsg>{errors.fileUrl}</ErrorMsg>
                </div>
              )}
            </div>
        ...
        <div className="flex flex-col gap-3.5">
          ...
          <Card>
            ...
            <div className="text-[12px] text-text-3 space-y-2">
              ...
              <p>
                Best options: live project URL, GitHub repository, demo URL, or
